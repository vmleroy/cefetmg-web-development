...
const imagens = [
  ...
  const onClickAnterior = () => {    
    indice = (indice + imagens.length - 1) % imagens.length;

    const img = document.getElementById('slide');
    img.src = servidorDasImagens + imagens[indice].arquivo;
    img.alt = imagens[indice].descricao;
  }
  ...
  document.getElementById('anterior').addEventListener('click', onClickAnterior);
  document.getElementById('proximo').addEventListener('click', onClickAvanca);
